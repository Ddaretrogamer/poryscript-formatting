...
class TextValidator {
    ...
    validateSegmentCharByChar(text, startPos, document, maxLineLength, validRanges, warningRanges) {
        let currentWidth = 0;
        let i = 0;
        let validStart = -1;
        let warningStart = -1;
        ...
        while (i < text.length) {
            ...
            if (text[i] === '{') {
                ...
                if (endBrace !== -1) {
                    ...
                    charWidth = (0, fontWidths_1.getCharacterWidth)(placeholder);
                    charEnd = endBrace + 1;
                }
                else {
                    charWidth = (0, fontWidths_1.getCharacterWidth)(text[i]);
                }
            }
            else {
                charWidth = (0, fontWidths_1.getCharacterWidth)(text[i]);
